...
## Project Structure
    ...
    ├── testapiautostorybo_120351  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_120351`
...
2. Clone this repo and `cd testapiautostorybo_120351`
